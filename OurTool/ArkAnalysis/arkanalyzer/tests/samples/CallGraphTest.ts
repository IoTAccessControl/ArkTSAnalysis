...
function runDir(): void {
    ...
    entryPoints.push(
        ...projectScene
            .getFiles()
            .filter(arkFile => arkFile.getName() === 'entry/.preview/default/cache/default/default@PreviewArkTS/esmodule/debug/entry/src/main/ets/entryability/EntryAbility.ts')
