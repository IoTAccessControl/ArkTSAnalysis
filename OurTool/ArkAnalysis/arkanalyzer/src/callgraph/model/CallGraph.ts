...
export class CallGraphEdge extends BaseEdge {
    ...
    /**
     * Returns the statements corresponding to *direct* call sites on this edge.
     * These statements are expected to be located in the caller method.
     */
    public getDirectCallSites(): Stmt[] {
        return Array.from(this.directCalls);
    }

    /**
     * Returns the statements corresponding to *special* call sites on this edge.
     */
    public getSpecialCallSites(): Stmt[] {
        return Array.from(this.specialCalls);
    }

    /**
     * Returns the statements corresponding to *indirect* (dynamic) call sites on this edge.
     */
    public getInDirectCallSites(): Stmt[] {
        return Array.from(this.indirectCalls);
    }
