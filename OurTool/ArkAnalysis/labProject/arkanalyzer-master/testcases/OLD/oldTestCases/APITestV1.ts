...
//const logger = Logger.getLogger(LOG_MODULE_TYPE.TOOL, 'PRINT_SYSTEM_API');

/**
 * 按你本地路径改这里：
 * - CONFIG_JSON：你的 analyzePedometer.json
 * - LOG_FILE：输出统计结果的 log 文件
 */
const CONFIG_JSON = 'C:/Users/xsy/labProject/arkanalyzer-master/myTests/myJSON/test.json';
const LOG_FILE = 'C:/Users/xsy/labProject/arkanalyzer-master/myTests/output/testAPI.log';
