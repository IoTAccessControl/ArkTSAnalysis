...
class TypeUtils {
     ...
     */
    static createObfSourceFile(sourceFilePath, content, compilerOptions) {
        ...
        if (compilerOptions && compilerOptions.etsAnnotationsEnable === true) {
            return (0, typescript_1.createSourceFile)(sourceFilePath, content, typescript_1.ScriptTarget.ES2015, true, undefined, compilerOptions, true);
        }
