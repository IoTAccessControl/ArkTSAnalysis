...
class FileUtils {
    ...
    static createDirectory(dirPath) {
        if (!fs_2.default.existsSync(dirPath)) {
            fs_2.default.mkdirSync(dirPath, { recursive: true });
        }
    }
    static deleteFolderRecursive(folderPath) {
        if (fs_2.default.existsSync(folderPath)) {
            const files = fs_2.default.readdirSync(folderPath);
            ...
            fs_2.default.rmdirSync(folderPath);
        }
    }
}
