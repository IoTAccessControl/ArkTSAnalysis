...
const PrinterTimeAndMemUtils_1 = require("../../utils/PrinterTimeAndMemUtils");
...
const KeepParameterUtils_1 = require("../../utils/KeepParameterUtils");
...
(function (secharmony) {
    ...
    const createRenameIdentifierFactory = function (option) {
        ...
        const shouldPrintKeptNames = !!((_a = option.mUnobfuscationOption) === null || _a === void 0 ? void 0 : _a.mPrintKeptNames);
        const enablePropertyObf = !!(profile === null || profile === void 0 ? void 0 : profile.mRenameProperties);
        if (!profile || !profile.mEnable) {
            return null;
        }
        let options = {};
        secharmony.globalGenerator = (0, NameFactory_1.getNameGenerator)(profile.mNameGeneratorType, options);
        const enableToplevel = (_b = option === null || option === void 0 ? void 0 : option.mNameObfuscation) === null || _b === void 0 ? void 0 : _b.mTopLevel;
        ...
        function renameIdentifierFactory(context) {
            (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.INIT_WHITELIST);
            initWhitelist();
            (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.INIT_WHITELIST);
            ...
            ScopeAnalyzer_1.nodeSymbolMap.clear();
            ...
            let isCurFileParamertersKept = false;
            ...
            function renameTransformer(node) {
                ...
                currentFileType = ArkObfuscator_1.FileUtils.getFileSuffix(node.fileName).ext;
                isCurFileParamertersKept = (0, KeepParameterUtils_1.shouldKeepCurFileParamerters)(node, profile);
                const checkRecordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.CREATE_CHECKER);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_CHECKER, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                checker = TypeUtils_1.TypeUtils.createChecker(node);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_CHECKER, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                ArkObfuscator_1.ArkObfuscator.stopRecordStage(checkRecordInfo);
                const scopeRecordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.SCOPE_ANALYZE);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SCOPE_ANALYZE, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                manager.analyze(node, checker, exportObfuscation, currentFileType);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SCOPE_ANALYZE, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                ArkObfuscator_1.ArkObfuscator.stopRecordStage(scopeRecordInfo);
                ...
                const obfuscateNamesRecordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.OBFUSCATE_NAMES);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_OBFUSCATED_NAMES, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                getMangledNamesInScope(rootScope, renameProcessors);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_OBFUSCATED_NAMES, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                ArkObfuscator_1.ArkObfuscator.stopRecordStage(obfuscateNamesRecordInfo);
                rootScope = undefined;
                const obfuscateNodesRecordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.OBFUSCATE_NODES);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.OBFUSCATE_NODES, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.RENAME_IDENTIFIERS);
                let updatedNode = renameIdentifiers(node);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.RENAME_IDENTIFIERS);
                // obfuscate property parameter declaration
                if (profile.mRenameProperties) {
                    (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.VISIT_PROPERTY_PARAMETER);
                    updatedNode = visitPropertyParameter(updatedNode);
                    (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.VISIT_PROPERTY_PARAMETER);
                }
                let parentNodes = (0, typescript_1.setParentRecursive)(updatedNode, true);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.OBFUSCATE_NODES, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                ArkObfuscator_1.ArkObfuscator.stopRecordStage(obfuscateNodesRecordInfo);
                return parentNodes;
            }
            /**
            ...
            function renameNamesInScope(scope) {
                ...
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.RENAME);
                renames(scope, scope.defs, secharmony.globalGenerator);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.RENAME);
            }
            ...
            function renamePropertyParametersInScope(scope) {
                ...
                renamePropertyParameters(scope, scope.defs, secharmony.globalGenerator);
            }
            function renames(scope, defs, generator) {
                defs.forEach((def) => {
                    ...
                    if (!Reflect.has(def, 'obfuscateAsProperty') &&
                        (0, TransformUtil_1.isInLocalWhitelist)(original, CommonCollections_1.UnobfuscationCollections.unobfuscatedNamesMap, path, shouldPrintKeptNames) ||
                    ...
                    const declarationOfSymbol = (_a = def.declarations) === null || _a === void 0 ? void 0 : _a[0];
                    if (isCurFileParamertersKept && (0, KeepParameterUtils_1.shouldKeepParameter)(declarationOfSymbol, profile, mangledSymbolNames, checker)) {
                        mangledSymbolNames.set(def, { mangledName: mangled, originalNameWithScope: path });
                        return;
                    }
            ...
            function renamePropertyParameters(scope, defs, generator) {
                defs.forEach((def) => {
                    ...
                    let mangledName;
                    if ((0, TransformUtil_1.isInPropertyWhitelist)(originalName, CommonCollections_1.UnobfuscationCollections.unobfuscatedPropMap, shouldPrintKeptNames)) {
            ...
            function getMangledPropertyParameters(scope, localGenerator, originalName) {
                ...
                while (!mangledName) {
                    ...
                    if (CommonCollections_1.PropCollections.globalMangledNamesInCache.has(tmpName)) {
                        continue;
                    }
            ...
            function getMangledName(original) {
                var _a, _b;
                ...
                while (!mangledName) {
                    let tmpName = secharmony.globalGenerator.getName();
                    if ((0, TransformUtil_1.isReservedTopLevel)(tmpName, enablePropertyObf) ||
                        tmpName === original) {
                        continue;
                    }
                    /**
                    ...
                    if (ApiExtractor_1.ApiExtractor.mConstructorPropertySet.has(tmpName)) {
                        continue;
                    }
                    if ((_b = ApiExtractor_1.ApiExtractor.mEnumMemberSet) === null || _b === void 0 ? void 0 : _b.has(tmpName)) {
                        continue;
                    }
                    mangledName = tmpName;
                }
            ...
            function getPropertyMangledName(originalName, nameWithScope) {
                if ((0, TransformUtil_1.isInTopLevelWhitelist)(originalName, CommonCollections_1.UnobfuscationCollections.unobfuscatedNamesMap, nameWithScope, enablePropertyObf, shouldPrintKeptNames)) {
                    return originalName;
                }
            ...
            function getAnnotationMangledNameWithPrefix(originalName, nameWithScope) {
                if ((0, TransformUtil_1.isInTopLevelWhitelist)(originalName, CommonCollections_1.UnobfuscationCollections.unobfuscatedNamesMap, nameWithScope, enablePropertyObf, shouldPrintKeptNames)) {
                    return `${type_1.annotationPrefix}${originalName}`;
                }
                let mangledName = `${type_1.annotationPrefix}${getMangledName(originalName)}`;
                return mangledName;
            }
            function getPropertyOrAnnotationMangledName(originalName, nameWithScope) {
                let name = originalName.startsWith(type_1.annotationPrefix) ? originalName.substring(type_1.annotationPrefix.length) : undefined;
                if (name) {
            ...
            function getMangledLocalName(scope, localGenerator) {
                var _a;
                let mangled = '';
                do {
                     ...
                     * For incremental compilation, preventing generated names from conflicting with existing global name.
                     */
                    if (CommonCollections_1.PropCollections.globalMangledNamesInCache.has(mangled)) {
                        mangled = '';
                        continue;
                    }
                    ...
                    if (ApiExtractor_1.ApiExtractor.mConstructorPropertySet.has(mangled)) {
                        mangled = '';
                    }
                    if ((_a = ApiExtractor_1.ApiExtractor.mEnumMemberSet) === null || _a === void 0 ? void 0 : _a.has(mangled)) {
                        mangled = '';
                    }
                } while (mangled === '');
                return mangled;
            ...
            function getMangledLabel(label, mangledLabels) {
                let mangledLabel = '';
                do {
                    mangledLabel = secharmony.globalGenerator.getName();
            ...
            function renameIdentifiers(node) {
                (0, PrinterTimeAndMemUtils_1.startSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.HANDLE_POSITION_INFO);
                ...
                (0, PrinterTimeAndMemUtils_1.endSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.HANDLE_POSITION_INFO);
                ...
                (0, PrinterTimeAndMemUtils_1.startSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_NAME_NODE);
                const updatedNode = updateNameNode(node);
                (0, PrinterTimeAndMemUtils_1.endSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_NAME_NODE);
                return updatedNode;
            }
            /**
            ...
            function updateNameNode(node) {
                ...
                let sym = NodeUtils_1.NodeUtils.findSymbolOfIdentifier(checker, node, ScopeAnalyzer_1.nodeSymbolMap);
        ...
        function initWhitelist() {
            ...
            if (enablePropertyObf) {
                ...
                (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtKeepCollections.keepSymbol.propertyNames);
                (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtKeepCollections.keepAsConsumer.propertyNames);
                (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtIntentCollections.propertyNames);
            ...
            CommonCollections_1.PropCollections.globalMangledNamesInCache = new Set((_b = CommonCollections_1.PropCollections.historyMangledTable) === null || _b === void 0 ? void 0 : _b.values());
            ...
            (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtKeepCollections.keepSymbol.globalNames);
            (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtKeepCollections.keepAsConsumer.globalNames);
            (0, ProjectCollections_1.addToSet)(CommonCollections_1.PropCollections.reservedProperties, CommonCollections_1.AtIntentCollections.globalNames);
            (0, ProjectCollections_1.addToSet)(CommonCollections_1.UnobfuscationCollections.reservedSdkApiForProp, CommonCollections_1.BytecodeObfuscationCollections.decoratorProp);
