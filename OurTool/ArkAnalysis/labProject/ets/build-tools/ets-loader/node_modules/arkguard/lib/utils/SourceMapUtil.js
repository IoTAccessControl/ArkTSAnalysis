...
exports.getSourceMapGenerator = void 0;
const typescript_1 = require("typescript");
/**
 * create sourcemap generator use api of typescript
 * @param sourceFile: file path of source code
 */
function getSourceMapGenerator(sourceFile) {
    let compilerOptions = {};
    let compilerHost = (0, typescript_1.createCompilerHost)(compilerOptions);
    function getCanonicalFileName(fileName) {
        return compilerHost.getCanonicalFileName(fileName);
    }
    const currentDirectory = compilerHost.getCurrentDirectory();
    let host = {
    ...
    const generatorOptions = { extendedDiagnostics: false };
    return (0, typescript_1.createSourceMapGenerator)(host, sourceFile, currentDirectory, currentDirectory, generatorOptions);
}
exports.getSourceMapGenerator = getSourceMapGenerator;
