import type { Identifier, Node, ObjectBindingPattern, SourceFile, TypeChecker, TransformerFactory, StringLiteralLike, NumericLiteral, PrivateIdentifier } from 'typescript';
...
export declare class NodeUtils {
    ...
    static isObjectLiteralInAnnotation(node: Node, currentFileType: string): boolean;
    ...
    static findSymbolOfIdentifier(checker: TypeChecker, node: Identifier, nodeSymbolMap: Map<Node, Symbol>): Symbol | undefined;
    static isPropertyNameType(node: Node): node is StringLiteralLike | Identifier | PrivateIdentifier | NumericLiteral;
}
/**
