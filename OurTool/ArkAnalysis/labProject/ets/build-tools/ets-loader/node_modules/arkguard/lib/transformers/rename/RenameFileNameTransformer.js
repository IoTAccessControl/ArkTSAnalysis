...
(function (secharmony) {
    ...
    const createRenameFileNameFactory = function (options) {
        var _a, _b;
        (0, PrinterUtils_1.startFilesEvent)(PrinterTimeAndMemUtils_1.EventList.FILENAME_OBFUSCATION_INITIALIZATION);
        profile = options === null || options === void 0 ? void 0 : options.mRenameFileName;
        if (!profile || !profile.mEnable) {
            (0, PrinterUtils_1.endFilesEvent)(PrinterTimeAndMemUtils_1.EventList.FILENAME_OBFUSCATION_INITIALIZATION);
            return null;
        }
        ...
        function renameFileNameFactory(context) {
            ...
            function renameFileNameTransformer(node) {
                ...
                const recordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.FILENAME_OBFUSCATION);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.FILENAME_OBFUSCATION, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                ...
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.FILENAME_OBFUSCATION, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_PARENT_NODE);
                let parentNodes = (0, typescript_1.setParentRecursive)(ret, true);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_PARENT_NODE);
            ...
            function updateNodeInfo(node) {
                if ((0, typescript_1.isImportDeclaration)(node) || (0, typescript_1.isExportDeclaration)(node)) {
                    (0, PrinterTimeAndMemUtils_1.startSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_IMPORT_OR_EXPORT);
                    const updatedNode = updateImportOrExportDeclaration(node);
                    (0, PrinterTimeAndMemUtils_1.endSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_IMPORT_OR_EXPORT);
                    return updatedNode;
                }
                if (isImportCall(node)) {
                    (0, PrinterTimeAndMemUtils_1.startSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_DYNAMIC_IMPORT);
                    const tryUpdatedNode = tryUpdateDynamicImport(node);
                    (0, PrinterTimeAndMemUtils_1.endSingleFileForMoreTimeEvent)(PrinterTimeAndMemUtils_1.EventList.UPDATE_DYNAMIC_IMPORT);
