import type { CompilerOptions, SourceFile, Symbol, TypeChecker } from 'typescript';
export declare class TypeUtils {
     ...
     */
    static createObfSourceFile(sourceFilePath: string, content: string, compilerOptions?: CompilerOptions): SourceFile;
