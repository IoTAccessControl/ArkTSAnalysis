...
const PrinterTimeAndMemUtils_1 = require("./PrinterTimeAndMemUtils");
var EventList;
(function (EventList) {
...
const eventListValues = new Set(Object.values(EventList));
...
function startSingleFileEvent(eventName, timeSumPrinter, currentFile) {
    ...
    if (eventListValues.has(eventName) || !PrinterTimeAndMemUtils_1.eventListTimeAndMemValues.has(eventName)) {
    ...
    (_b = ArkObfuscator_1.performanceTimeAndMemPrinter.singleFilePrinter) === null || _b === void 0 ? void 0 : _b.startEvent(eventName);
}
...
function endSingleFileEvent(eventName, timeSumPrinter, isFilesPrinter, triggerSingleFilePrinter) {
    ...
    (_b = ArkObfuscator_1.performanceTimeAndMemPrinter.singleFilePrinter) === null || _b === void 0 ? void 0 : _b.endEvent(eventName);
}
...
function startFilesEvent(eventName, timeSumPrinter, currentFile) {
    ...
    (_b = ArkObfuscator_1.performanceTimeAndMemPrinter.filesPrinter) === null || _b === void 0 ? void 0 : _b.startEvent(eventName);
}
...
function endFilesEvent(eventName, timeSumPrinter, isFilesPrinter, triggerSingleFilePrinter) {
    ...
    (_b = ArkObfuscator_1.performanceTimeAndMemPrinter.filesPrinter) === null || _b === void 0 ? void 0 : _b.endEvent(eventName);
}
