...
exports.readProjectPropertiesByCollectedPaths = exports.resetScanProjectConfig = exports.initScanProjectConfigByMergeConfig = exports.initScanProjectConfig = exports.isEnabledPropertyObfuscation = exports.needReadApiInfo = exports.initPlugin = exports.scanProjectConfig = void 0;
...
function initScanProjectConfig(customProfiles, isHarCompiled, scanDecorator = false) {
    var _a, _b, _c, _d;
    ...
    exports.scanProjectConfig.mEnableAtKeep = (_d = customProfiles.mNameObfuscation) === null || _d === void 0 ? void 0 : _d.mEnableAtKeep;
    exports.scanProjectConfig.scanDecorator = scanDecorator;
}
exports.initScanProjectConfig = initScanProjectConfig;
/**
 * Initialize scanProjectConfig by MergeConfig
 * @param mergedConfig
 */
function initScanProjectConfigByMergeConfig(config) {
    exports.scanProjectConfig.mStripSystemApiArgs = config.options.stripSystemApiArgs;
}
exports.initScanProjectConfigByMergeConfig = initScanProjectConfigByMergeConfig;
/**
 * Reset scanProjectConfig
 */
function resetScanProjectConfig() {
    exports.scanProjectConfig.mStripSystemApiArgs = undefined;
}
exports.resetScanProjectConfig = resetScanProjectConfig;
/**
 * read project reserved properties by collected paths
 * @param filesForCompilation set collection of files
 * @param customProfiles
 */
function readProjectPropertiesByCollectedPaths(filesForCompilation, customProfiles, isHarCompiled, scanDecorator = false) {
