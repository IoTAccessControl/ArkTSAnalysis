...
exports.performancePrinter = exports.cleanFileMangledNames = exports.orignalFilePathForSearching = exports.PropCollections = exports.ApiExtractor = exports.deleteLineInfoForNameString = exports.readProjectPropertiesByCollectedPaths = exports.getMapFromJson = exports.renameFileNameModule = exports.renameIdentifierModule = exports.collectReservedNameForObf = exports.writeUnobfuscationContent = exports.writeObfuscationNameCache = exports.clearNameCache = exports.readNameCache = exports.ObConfigResolver = exports.MergedConfig = exports.mangleFilePath = exports.handleUniversalPathInObf = exports.handleObfuscatedFilePath = exports.getRelativeSourcePath = exports.generateConsumerObConfigFile = exports.enableObfuscateFileName = exports.enableObfuscatedFilePathConfig = exports.collectResevedFileNameInIDEConfig = exports.unobfuscationNamesObj = exports.nameCacheMap = exports.printerTimeAndMemDataConfig = exports.initObfuscationConfig = exports.wildcardTransformer = exports.containWildcards = exports.separateUniversalReservedItem = exports.ProjectCollections = exports.UnobfuscationCollections = exports.MemoryUtils = exports.FileUtils = exports.enableTimeAndMemoryPrint = exports.configurePerformancePrinter = exports.blockTimeAndMemPrinter = exports.TimeAndMemTimeTracker = exports.PerfMode = exports.EventList = exports.startSingleFileEvent = exports.startFilesEvent = exports.printTimeSumInfo = exports.printTimeSumData = exports.endSingleFileEvent = exports.endFilesEvent = exports.blockPrinter = exports.TimeSumPrinter = void 0;
exports.ArkObfuscator = exports.clearGlobalCaches = exports.performanceTimeAndMemPrinter = void 0;
...
const es_reserved_properties_optimized_json_1 = __importDefault(require("./configs/preset/es_reserved_properties_optimized.json"));
...
var PrinterTimeAndMemUtils_2 = require("./utils/PrinterTimeAndMemUtils");
Object.defineProperty(exports, "EventList", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.EventList; } });
Object.defineProperty(exports, "PerfMode", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.PerfMode; } });
Object.defineProperty(exports, "TimeAndMemTimeTracker", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.TimeAndMemTimeTracker; } });
Object.defineProperty(exports, "blockTimeAndMemPrinter", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.blockTimeAndMemPrinter; } });
Object.defineProperty(exports, "configurePerformancePrinter", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.configurePerformancePrinter; } });
Object.defineProperty(exports, "enableTimeAndMemoryPrint", { enumerable: true, get: function () { return PrinterTimeAndMemUtils_2.enableTimeAndMemoryPrint; } });
...
exports.ProjectCollections = __importStar(require("./utils/ProjectCollections"));
...
Object.defineProperty(exports, "printerTimeAndMemDataConfig", { enumerable: true, get: function () { return Initializer_2.printerTimeAndMemDataConfig; } });
var CommonObject_2 = require("./initialization/CommonObject");
Object.defineProperty(exports, "nameCacheMap", { enumerable: true, get: function () { return CommonObject_2.nameCacheMap; } });
Object.defineProperty(exports, "unobfuscationNamesObj", { enumerable: true, get: function () { return CommonObject_2.unobfuscationNamesObj; } });
...
Object.defineProperty(exports, "clearNameCache", { enumerable: true, get: function () { return ConfigResolver_1.clearNameCache; } });
...
exports.performanceTimeAndMemPrinter = {
    filesPrinter: new PrinterTimeAndMemUtils_1.TimeAndMemTimeTracker(),
    singleFilePrinter: new PrinterTimeAndMemUtils_1.TimeAndMemTimeTracker(),
};
...
function clearGlobalCaches() {
    ...
    CommonCollections_1.AtKeepCollections.clear();
    CommonCollections_1.AtIntentCollections.clear();
    exports.renameFileNameModule.clearCaches();
    (0, CommonObject_1.clearUnobfuscationNamesObj)();
    (0, Initializer_1.clearHistoryUnobfuscatedMap)();
    (0, PrinterTimeAndMemUtils_1.clearTimeAndMemPrinterData)();
    (0, PrinterTimeAndMemUtils_1.disablePrinterTimeAndMemConfig)();
    ApiExtractor_1.ApiExtractor.mConstructorPropertySet.clear();
    ApiExtractor_1.ApiExtractor.mEnumMemberSet.clear();
    CommonCollections_1.BytecodeObfuscationCollections.clear();
}
...
class ArkObfuscator {
    constructor() {
        ...
        this.shouldReObfuscate = false;
        this.mCompilerOptions = {};
        this.mTransformers = [];
    }
    getWriteOriginalFileForTest() {
    ...
    static stopRecordStage(recordInfo) {
    ...
    isCurrentFileInKeepPathsForTest(customProfiles, originalFilePath) {
    ...
    init(config, cachePath) {
        ...
        (0, PrinterTimeAndMemUtils_1.initPerformanceTimeAndMemPrinter)();
        if ((0, ApiReader_1.needReadApiInfo)(this.mCustomProfiles)) {
            ...
            let presetLanguageWhitelist = this.mCustomProfiles.mStripLanguageDefaultWhitelist ? es_reserved_properties_optimized_json_1.default : es_reserved_properties_json_1.default;
    ...
    static setMemoryDottingCallBack(memoryDottingCallback, memoryDottingStopCallback) {
    ...
    static clearMemoryDottingCallBack() {
     ...
     */
    initIncrementalCache(cachePath, enableAtKeep) {
        this.filePathManager = new ProjectCollections_1.FilePathManager(cachePath);
        this.isIncremental = this.filePathManager.isIncremental();
        this.fileContentManager = new ProjectCollections_1.FileContentManager(cachePath, this.isIncremental);
        (0, ProjectCollections_1.initProjectWhiteListManager)(cachePath, this.isIncremental, enableAtKeep);
    }
    /**
    ...
    convertLineBasedOnSourceMap(targetCache, sourceMapLink) {
        ...
        for (const [key, value] of originalCache) {
            ...
            const lastScopeName = parts[parts.length - 1];
    ...
    convertLineBasedOnSourceMapForTest(targetCache, sourceMapLink) {
    ...
    obfuscate(content, sourceFilePathObj, previousStageSourceMap, historyNameCache, originalFilePath, projectInfo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            (0, PrinterUtils_1.startFilesEvent)(PrinterTimeAndMemUtils_1.EventList.CONFIG_INITIALIZATION);
            ...
            if (this.isObfsIgnoreFile(sourceFilePathObj.buildFilePath)) {
                ...
                (0, PrinterUtils_1.endFilesEvent)(PrinterTimeAndMemUtils_1.EventList.CONFIG_INITIALIZATION);
                return result;
            }
            ...
            (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.WRITE_OBFUSCATION_RESULT);
            this.writeObfuscationResult(ast, sourceFilePathObj.buildFilePath, result, previousStageSourceMap, originalFilePath);
            (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.WRITE_OBFUSCATION_RESULT);
            this.clearCaches();
            return result;
        });
    }
    createAst(content, sourceFilePath) {
        const recordInfo = ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.CREATE_AST);
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_AST, exports.performancePrinter.timeSumPrinter);
        let ast;
        if (typeof content === 'string') {
            ast = TypeUtils_1.TypeUtils.createObfSourceFile(sourceFilePath, content, this.mCompilerOptions);
        }
        else {
            ast = content;
        }
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_AST, exports.performancePrinter.timeSumPrinter);
        ArkObfuscator.stopRecordStage(recordInfo);
        return ast;
    }
    obfuscateAst(ast) {
        const recordInfo = ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.OBFUSCATE_AST);
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.OBFUSCATE_AST, exports.performancePrinter.timeSumPrinter);
        let transformedResult = (0, typescript_1.transform)(ast, this.mTransformers, this.mCompilerOptions);
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.OBFUSCATE_AST, exports.performancePrinter.timeSumPrinter);
        ArkObfuscator.stopRecordStage(recordInfo);
    ...
    writeObfuscationResult(ast, sourceFilePath, result, previousStageSourceMap, originalFilePath) {
        ...
        if (this.mCustomProfiles.mEnableSourceMap) {
            (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.GET_SOURCEMAP_GENERATOR, exports.performancePrinter.timeSumPrinter);
            sourceMapGenerator = (0, SourceMapUtil_1.getSourceMapGenerator)(sourceFilePath);
            (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.GET_SOURCEMAP_GENERATOR, exports.performancePrinter.timeSumPrinter);
        }
        if (sourceFilePath.endsWith('.js')) {
            TypeUtils_1.TypeUtils.tsToJs(ast);
        }
        this.handleTsHarComments(ast, originalFilePath);
        const recordInfo = ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.CREATE_PRINTER);
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_PRINTER, exports.performancePrinter.timeSumPrinter);
        this.createObfsPrinter(ast.isDeclarationFile).writeFile(ast, this.mTextWriter, sourceMapGenerator);
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_PRINTER, exports.performancePrinter.timeSumPrinter);
        ArkObfuscator.stopRecordStage(recordInfo);
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.GET_OBFUSCATED_CODE);
        result.filePath = ast.fileName;
        result.content = this.mTextWriter.getText();
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.GET_OBFUSCATED_CODE);
        if ((_a = this.mCustomProfiles.mUnobfuscationOption) === null || _a === void 0 ? void 0 : _a.mPrintKeptNames) {
            this.handleUnobfuscationNames(result);
        }
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.PROCESS_SOURCEMAP);
        ...
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.PROCESS_SOURCEMAP);
    }
    ...
    handleSourceMapAndNameCache(sourceMapGenerator, sourceFilePath, result, previousStageSourceMap) {
        var _a;
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SOURCEMAP_MERGE, exports.performancePrinter.timeSumPrinter);
        ...
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SOURCEMAP_MERGE, exports.performancePrinter.timeSumPrinter);
        (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_NAMECACHE, exports.performancePrinter.timeSumPrinter);
        ...
        (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.CREATE_NAMECACHE, exports.performancePrinter.timeSumPrinter);
    }
    clearCaches() {
