    ...
    const createShorthandPropertyTransformerFactory = function (option) {
        ...
        function shorthandPropertyTransformFactory(context) {
            ...
            function shorthandPropertyTransformer(node) {
                ...
                const recordInfo = ArkObfuscator_1.ArkObfuscator.recordStage(MemoryDottingDefine_1.MemoryDottingDefine.SHORTHAND_OBFUSCATION);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SHORT_HAND_OBFUSCATION, ArkObfuscator_1.performancePrinter.timeSumPrinter);
                (0, PrinterUtils_1.startSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.TRANSFORM_SHORT_HAND_PROPERTY);
                let ret = transformShortHandProperty(node);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.TRANSFORM_SHORT_HAND_PROPERTY);
                let parentNodes = (0, typescript_1.setParentRecursive)(ret, true);
                (0, PrinterUtils_1.endSingleFileEvent)(PrinterTimeAndMemUtils_1.EventList.SHORT_HAND_OBFUSCATION, ArkObfuscator_1.performancePrinter.timeSumPrinter);
