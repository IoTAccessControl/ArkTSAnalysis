...
exports.getViewPUClassProperties = exports.visitEnumInitializer = exports.addExportPropertyName = exports.getObjectExportNames = exports.getStructProperties = exports.getObjectProperties = exports.getEnumProperties = exports.getClassProperties = exports.isParameterPropertyModifier = exports.getInterfaceProperties = exports.getTypeAliasProperties = exports.getIndexedAccessTypeProperties = exports.getElementAccessExpressionProperties = exports.collectPropertyNamesAndStrings = exports.collectReservedStruct = exports.isViewPUBasedClass = exports.exportOriginalNameSet = exports.enumPropsSet = exports.structPropsSet = exports.stringPropsSet = void 0;
const typescript_1 = require("typescript");
const ApiExtractor_1 = require("../common/ApiExtractor");
const CommonCollections_1 = require("./CommonCollections");
const ProjectCollections_1 = require("./ProjectCollections");
...
function collectReservedStruct(memberName, reservedStruct) {
    var _a;
    const structPropertiesTemp = (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileKeepInfo.structProperties;
    if ((0, typescript_1.isIdentifier)(memberName) || (0, typescript_1.isStringLiteral)(memberName)) {
        reservedStruct.add(memberName.text);
        structPropertiesTemp === null || structPropertiesTemp === void 0 ? void 0 : structPropertiesTemp.add(memberName.text);
    }
    if ((0, typescript_1.isComputedPropertyName)(memberName) && (0, typescript_1.isStringLiteral)(memberName.expression)) {
        ...
        structPropertiesTemp === null || structPropertiesTemp === void 0 ? void 0 : structPropertiesTemp.add(memberName.expression.text);
    }
}
exports.collectReservedStruct = collectReservedStruct;
function collectPropertyNamesAndStrings(memberName, propertySet) {
    var _a;
    const stringPropertiesTemp = (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileKeepInfo.stringProperties;
    ...
    if ((0, typescript_1.isStringLiteral)(memberName)) {
        ...
        stringPropertiesTemp === null || stringPropertiesTemp === void 0 ? void 0 : stringPropertiesTemp.add(memberName.text);
    }
    if ((0, typescript_1.isComputedPropertyName)(memberName) && (0, typescript_1.isStringLiteral)(memberName.expression)) {
        propertySet.add(memberName.expression.text);
        exports.stringPropsSet.add(memberName.expression.text);
        stringPropertiesTemp === null || stringPropertiesTemp === void 0 ? void 0 : stringPropertiesTemp.add(memberName.expression.text);
    }
}
...
function getElementAccessExpressionProperties(elementAccessExpressionNode) {
    ...
    if ((0, typescript_1.isStringLiteral)(elementAccessExpressionNode.argumentExpression)) {
        ...
        (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileKeepInfo.stringProperties.add(elementAccessExpressionNode.argumentExpression.text);
    }
}
...
function addStringLiteralToSet(node, stringSet) {
    ...
    if (NodeUtils_1.NodeUtils.isStringLiteralTypeNode(node)) {
        ...
        (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileKeepInfo.stringProperties.add(stringLiteral.text);
    }
}
/**
                ...
                if ((0, typescript_1.isParameter)(parameter) && modifiers && modifiers.length > 0) {
                    if (parameter.name && (0, typescript_1.isIdentifier)(parameter.name)) {
                        ...
                        if (hasParameterPropertyModifier) {
                            ...
                            ApiExtractor_1.ApiExtractor.mConstructorPropertySet.add(parameter.name.text);
                            (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileReservedInfo.propertyParams.add(parameter.name.text);
                        }
                    }
...
function getStructProperties(structNode, propertySet) {
    var _a;
    const fileWhiteLists = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo;
    (_a = structNode === null || structNode === void 0 ? void 0 : structNode.members) === null || _a === void 0 ? void 0 : _a.forEach((member) => {
        ...
        if (fileWhiteLists) {
            ...
            (0, ProjectCollections_1.addToSet)(propertySet, fileWhiteLists.fileKeepInfo.structProperties);
        }
        else {
            collectPropertyNamesAndStrings(memberName, propertySet);
        }
...
function visitEnumInitializer(childNode) {
    ...
    (_a = ProjectCollections_1.projectWhiteListManager === null || ProjectCollections_1.projectWhiteListManager === void 0 ? void 0 : ProjectCollections_1.projectWhiteListManager.fileWhiteListInfo) === null || _a === void 0 ? void 0 : _a.fileKeepInfo.enumProperties.add(childNode.text);
}
...
function getViewPUClassProperties(classNode) {
    ...
    classNode.members.forEach((member) => {
        ...
        collectReservedStruct(memberName, CommonCollections_1.UnobfuscationCollections.reservedStruct);
    });
}
